...
(function () {
  ...
  prepBtn.onclick = function(){
    ...
    function finishReading(){
      ...
      statusText.innerHTML = '🎉 <strong>Read Complete!</strong><br>Collected <strong style="color:#16a34a;">' + collectedPosts.length + ' posts</strong> in <strong>' + pageCount + ' pages</strong>. Click <strong>Save for SPB app</strong> below.';
    }
  };
